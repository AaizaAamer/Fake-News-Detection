...
ENGLISH_STOPWORDS = {
    ...
    'did','do','does','for','from','had','has','have','he','her','here','him','his','how','i','if','in','into','is',
    'it','its','just','me','more','my','no','not','of','on','one','or','our','out','said','she','so','some','such','than',
